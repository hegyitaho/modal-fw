import { JSX, JSXElementConstructor, PropsWithChildren } from 'react';
...
export type OpenedModalProps = Omit<ModalProps, 'isOpen' | 'isFullScreen' | 'isBlocking' | 'contentComponentToRender' | 'buttons'> & {
    buttons: JSX.Element;
};
